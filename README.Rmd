...
```{r echo=FALSE}
pan_ancestry<- data.frame(Threshold="0.2", Distance="250kb", R2="0.1",Trait="HTN", Study="Pan-UKBB", Topmed_mean=4.46e-06, Topmed_sd=4.07e-06)
mvp_DBP<- data.frame(Threshold="0.1", Distance="1000kb", R2="0.1", Trait="DBP",Study="MVP",Topmed_mean=-4.95e-04, Topmed_sd=2.63e-04)
mvp_SBP<- data.frame(Threshold="0.01", Distance="1000kb", R2="0.1", Trait="SBP",Study="MVP",Topmed_mean=-4.63e-03, Topmed_sd=1.11e-03)
