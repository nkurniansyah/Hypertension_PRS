...
This is the instruction to construct generate and run the association test for Polygenic Risk Score in Hypertension. This instruction is based on the manuscript:...
